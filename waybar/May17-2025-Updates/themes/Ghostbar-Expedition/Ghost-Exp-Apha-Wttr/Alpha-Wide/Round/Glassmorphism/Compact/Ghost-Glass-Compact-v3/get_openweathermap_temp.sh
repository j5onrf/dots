...
# Examples:
# LOCATION="4407074"         (City ID for Seckman, MO, USA - Recommended)
# LOCATION="Seckman,US,MO"  (City, Country, State)
# LOCATION="63052,us"        (ZIP Code)
# LOCATION="lat=38.40&lon=-90.43" (Latitude & Longitude)
LOCATION="0000000"
