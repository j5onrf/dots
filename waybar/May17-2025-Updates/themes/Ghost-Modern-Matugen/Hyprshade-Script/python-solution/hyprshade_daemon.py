...
ICON_ON = "\ue019"  # light-switch: \ye019 --- light-bulb: \uf673
ICON_OFF = "\ue018" # light-switch: \ue018 --- light-bulb: \uf0eb
...
def get_chosen_shader():
    ...
    try:
        with open(SETTINGS_FILE, 'r') as f:
            # Reads the line 'hyprshade_filter="shader-name"' and gets the name
...
def rofi_action(signum, frame):
    ...
    try:
        ...
        if choice:
            # Save the choice to the settings file for other tools to use
            with open(SETTINGS_FILE, 'w') as f:
                f.write(f'hyprshade_filter="{choice}"')
            
            # Immediately apply the choice
            if choice == "off":
        ...
        # Handles user canceling Rofi or command not found
        pass
    print_status()

# --- MAIN EXECUTION ---
# Register handlers for TWO different signals
