#!/bin/bash
#
# Waybar Weather & Forecast Script | Modern-Fusion
...
# data validation, and uses "Material Symbol" icons for weather conditions.
...
# --- Weather Icon Mapping (Material Design Icons with Thin Spacing) ---
get_emoji() {
    local code=$1
    case "$code" in
        800) printf "󰖙 ";; # Clear Sky
        801) printf "󰖕 ";; # Few Clouds
        802|803|804) printf "󰖐 ";; # Clouds
        5*) printf "󰖖 ";; # Rain
        2*) printf "󰙾 ";; # Thunderstorm
        6*) printf "󰼶 ";; # Snow
        7*) printf "󰖑 ";; # Mist/Fog
        *)  printf "󰖙 ";; # Default
    esac
...
# Drop the degree symbol for 3-digit temps to save horizontal space
if (( CURRENT_TEMP_NUM >= 100 )); then
