...
Dracula Soft
<img width="3440" height="1440" alt="FullScreen-2026-04-12_22-25-02" src="https://github.com/user-attachments/assets/fe774862-9885-40c2-9840-838a859b9b5e" />


</p>
</details>

<details><summary>(2026-April10) Omarchy Sidebar "Fusion": Caelestia Symlink-Swapping Script <sup>maybe in-works</sup></summary>
<p>
<br>
...
2. **Update the Config:** Add this to your `~/.config/matugen/config.toml`:
```toml
[[outputs]]
...
3. **Create the Bridge:** Create `~/.config/omarchy/themes/fusion/theme/waybar.css`:
```css
@import "colors.css";
/* Custom Fusion overrides go here */
```

> **Note:** For this to work with Caelestia-Shell, Matugen must be pointed to the local state file. You can trigger a manual sync using:
