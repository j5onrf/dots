        ...
        Rectangle {
            ...
            Column {
                ...
                FusionModule {
                    ...
                    hoverArea.onClicked: (mouse) => {
                        if (mouse.button === Qt.LeftButton) calendarOpen = !calendarOpen;
                    }
                }
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Text {
                        ...
                        color: theme.mPrimary
                        font { family: monoFont; weight: Font.Bold; pixelSize: 16 }
                    ...
                    Row {
                        ...
                        Repeater {
                            model:["S", "M", "T", "W", "T", "F", "S"]
                            Text {
                                width: 25; horizontalAlignment: Text.AlignHCenter
                                color: theme.mOnSurface; opacity: 0.5
                                font { family: monoFont; pixelSize: 10 }
                                text: modelData
                            }
                        }
                    }
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                Text {
                                    ...
                                    font { family: monoFont; pixelSize: 12; weight: parent.isToday ? Font.Bold : Font.Normal }
                                }
                            }
                        }
                    }
