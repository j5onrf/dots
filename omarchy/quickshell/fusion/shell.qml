/**
 * Shell-Fusion V3.8.1 4.27.26
 * Omarchy-Sync | Optimized
 */
...
PanelWindow {
    ...
    exclusionMode: autoHideEnabled ? PanelWindow.Ignore : PanelWindow.Exclusive
    color: "transparent"
    ...
    // ── PORTABLE THEME ENGINE ───────────────────────────────
    FileView {
        id: theme
        path: omarchyConfig // Uses the dynamic homeDir property
        watchChanges: true

        property var raw: ({})

        readonly property string mSurface:        raw.background || "#121212"
        readonly property string mOnSurface:      raw.foreground || "#bebebe"
        readonly property string mPrimary:        raw.accent     || "#e68e0d"
        readonly property string mOnPrimary:      "#000000"
        readonly property string mSurfaceVariant: raw.color0     || "#333333"
        readonly property string mError:          raw.color1     || "#D35F5F"
        ...
        Component.onCompleted: onFileChanged()
    }
